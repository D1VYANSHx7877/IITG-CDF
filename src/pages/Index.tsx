        ...
        <div className="container relative mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
            <div className="inline-flex items-center space-x-2 bg-primary/10 text-primary px-4 py-2 rounded-full mb-6 animate-fade-in">
              ...
              <span className="text-sm font-medium">IIT Gandhinagar Excellence</span>
            </div>
            ...
            <p className="text-lg lg:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Transform your career with IIT Gandhinagar's Postgraduate Diploma Programs in 
              Data Science, AI, and Software Development with Generative AI.
            </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { icon: <BookOpen className="w-6 h-6" />, value: "100%", label: "Industry Ready" },
            ].map((stat, index) => (
              <div 
                key={index}
                className="text-center p-8 bg-card rounded-2xl shadow-soft hover:shadow-medium transition-all duration-300 animate-fade-in"
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              As one of India's premier engineering institutes, IIT Gandhinagar offers transformational 
              Postgraduate Diploma programs designed to bridge academia with industry needs in the fields 
              of Data Science, Artificial Intelligence, and Software Development with Generative AI.
            </p>
            <p className="text-lg text-muted-foreground">
              Our programs are structured under the Competency Advancement Model, focusing on applied skills, 
              AI-assisted learning, and real-world industry relevance.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12 lg:mb-16 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Choose from three cutting-edge programs designed to equip you with the skills 
              needed for tomorrow's tech landscape.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="bg-gradient-hero rounded-2xl p-8 lg:p-16 text-center shadow-large animate-scale-in">
            ...
            <p className="text-lg lg:text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
              Join our PG Diploma programs and build expertise that opens doors to roles such as 
              Data Scientist, AI Engineer, Cloud Data Engineer, and more.
            </p>
            <Button 
              asChild 
              size="lg" 
